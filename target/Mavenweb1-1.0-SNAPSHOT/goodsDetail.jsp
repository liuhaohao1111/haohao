...
<body>
	<%@ include file="header.jsp"%>
	   ...
	   <ol class="breadcrumb">
		  <li><a href="#">小米商城</a></li>
		  <li><a href="#">手机</a></li>
		  <li class="active"><a href="getGoodsListByTypeId?typeid=${goods.goodsType.id}">${goods.goodsType.name}</a></li>
	   </ol>
   </div>
		...
		<div class="row">
		  <div class="col-xs-6 col-md-6">
		    <a href="#" class="thumbnail">
		      <img src="image/1.png"  width="430" height="430"  alt="${goods.name}" />
		    </a>
		  </div>
		  <div class="col-xs-6 col-md-6">
